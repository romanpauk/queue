...
BENCHMARK_TEMPLATE(queue_push_pop_sequential, queue::bounded_queue_spsc3< int, queue::static_storage< int, 1024 > >)->UseRealTime()->Threads(1)->Range(range_min, range_max);
